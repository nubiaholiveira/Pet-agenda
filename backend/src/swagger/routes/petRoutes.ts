 ...
 * tags:
 *   name: Pets
 *   description: Endpoints para gerenciar pets
 */
...
/**
 * @swagger
 * /pets/cliente/{clienteId}:
 *   get:
 *     summary: Listar pets de um cliente
 *     tags: [Pets]
 *     parameters:
 *       - in: path
 *         name: clienteId
 ...
 * /pets/{id}/cliente:
 *   get:
 *     summary: Obter pet com dados do cliente
 *     tags: [Pets]
 *     parameters:
 *       - in: path
 *         name: id
 ...
 *     responses:
 *       200:
 *         description: Pet com dados do cliente
 *         content:
 *           application/json:
 *             schema:
 *               type: object
 ...
 *     responses:
 *       200:
 *         description: Pet com lista de agendamentos
 *         content:
 *           application/json:
 *             schema:
 *               type: object
